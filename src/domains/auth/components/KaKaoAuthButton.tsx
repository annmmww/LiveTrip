...
import kakaoIcon from '@/domains/auth/assets/icon_kakao.svg';
import type { KaKaoAuthButtonProps } from '@/domains/auth/type';
import { getKaKaoAuthroizeURL } from '@/domains/auth/util';
