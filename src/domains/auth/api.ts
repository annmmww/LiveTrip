import { ApiError, apiFetch, BASE_URL } from '@/lib/api/api';
import {
  ...
  type SignUpResponse,
  type UserInfo,
} from '@/domains/auth/type';
import { endpoint } from '@/domains/auth/util';
...
export async function getNewToken(
  ...
  const res = await fetch(`${BASE_URL}${endpoint.NEW_TOKEN}`, {
    method: 'POST',
    headers: {
