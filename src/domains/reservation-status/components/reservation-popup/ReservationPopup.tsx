...
import ReservationCard from '@/domains/reservation-status/components/reservation-popup/ReservationCard';
import type {
  ReservationDetail,
  ReservationPopupProps,
  ReservationStatusType,
} from '@/domains/reservation-status/components/reservation-popup/type';
