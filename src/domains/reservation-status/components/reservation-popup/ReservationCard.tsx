...
import type { ReservationStatusType } from '@/domains/reservation-status/components/reservation-popup/type';
import StateBadge from '@/domains/reservation-status/components/state-badge/StateBadge';
import { toast } from '@/components/feedback/toast';
import { approveReservationAction } from '@/domains/reservation-status/actions/approve-reservation.action';
import { rejectReservationAction } from '@/domains/reservation-status/actions/reject-reservation.action';
