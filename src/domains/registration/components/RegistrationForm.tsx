...
import { BasicInfoFields } from '@/domains/registration/components/BasicInfoFields';
import ClientConfirmModal from '@/domains/registration/components/ClientConfirmModal';
import { ImageUploader } from '@/domains/registration/components/ImageUploader';
import { TimeSlotsField } from '@/domains/registration/components/TimeSlotsField';
import { useBannerImageUpload } from '@/domains/registration/hooks/useBannerImageUpload';
import { useIntroImageUpload } from '@/domains/registration/hooks/useIntroImageUpload';
import { useLeaveGuard } from '@/domains/registration/hooks/useLeaveGuard';
import { createEmptyTimeSlot } from '@/domains/registration/lib/createEmptyTimeSlot';
import type { FormValues, TimeSlot } from '@/domains/registration/type';
import type { MyActivityDetail } from '@/domains/activities/api';
import { saveActivityAction } from '@/domains/registration/actions/saveActivity';
