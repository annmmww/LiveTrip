...
import type { FormValues } from '@/domains/registration/type';
          ...
          <label className='flex w-full flex-col text-sm font-medium text-gray-900'>
            ...
            <div className='mt-2 flex gap-2'>
              <input
                {...field}
                readOnly
                className='h-[54px] flex-1 rounded-2xl border border-gray-100 bg-gray-50 px-4 text-gray-900 placeholder:text-gray-400 transition-colors focus:border-primary-500 focus:outline-none'
